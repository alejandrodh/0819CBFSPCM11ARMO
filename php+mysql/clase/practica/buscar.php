...
// Armar un buscador de SERIES o PELICULAS, el mismo archivo debe servir para buscar cualquier de las dos opciónes, por ejemplo a través de un radio-button, preguntar al usuario qué desea buscar y luego de eso, realizar la consulta a la DB. Generar errores si no se seleccionó el tipo de búsqueda y así mismo si la busqueda no arrojo resultados
?>
<!DOCTYPE html>
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <form class="" action="resultados.php" method="get">
      ...
      <input type="radio" name="type" value="movies"> Películas
